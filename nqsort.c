...
void
swapfunc(char *a, char *b, int32_t n, int32_t swaptype) {
	if(swaptype <= 1) 
...
char *
med3(char *a, char *b, char *c, int32_t (*cmp)(char * , char *)) {
	return cmp(a, b) < 0 ?
...
void
nqsort(char *a, uint32_t n, int32_t es, int32_t (*cmp)(char *, char *)) {
